...
import Link from "next/link";
  ...
  const nationalTeams = [
  {
      ...
      address: 'Comprised of players from across the United States and home to several top 20 ranked teams in the nation between the ages of 14U through 18U.',
      link: ''
  },
  {
    image: '/',
    name: 'East Coast Ghost Scout',
    address: 'Comprised of players from NJ, NY, PA, and other states and home to several top 20 ranked teams in the nation between the ages of 10U through 18U.',
    link: ''
},
]
  ...
  const Team = ({ image, name, address, link }: HeadshotProps) => {
    return (
      <Stack spacing={4} align="center" sx={{padding: '20px 0'}}>
        ...
        <Text sx={{textAlign: 'center', padding: '10px 0', minHeight: '70px' }}>{address}</Text>
        <Link href={link}>
